...
#include "AGUIElement/AGDynamicList.h"

#include "AGUIElement/AGUIElementShared.h"
#include "Components/PanelWidget.h"
#include "Components/CanvasPanel.h"

void UAGDynamicList::Setup() const
{
    // asserts
    check(TemplateItem);
...
void UAGDynamicList::Update(const int32 RequiredItems)
{
...
UCanvasPanel* UAGDynamicList::AddItem()
{
